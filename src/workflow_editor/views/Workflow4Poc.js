...
import WorkflowEditor4Poc from './WorkflowEditor4Poc';
...
@radium
export default class Workflow4Poc extends Component {
  ...
  render() {
    ...
    return (
      <div ref="root"
          className={'Workflow4Poc ' + props.className}
          style={css.root}>
        <WorkflowEditor4Poc height={this.props.toolbarHeight} />
      </div>
    );
  }
